...
export default function Produto({ src, nome, preco, key }: ProdutoProps) {
  return (
    ...
    >
      ...
      <p className="w-[100px] inline ms-5 truncate md:w-[280px] mt-2">{nome}</p>
      <div className="hidden md:inline h-[20px] border-[1px] border-[#333] w-0 ms-5 mt-2"></div>
      ...
      <div className="z-2 flex">
        ...
        <Link
          ...
          className="md:ms-8 transition ease-in-out duration-200 text-red-500 border-2 border-red-500 p-1 rounded-xl hover:text-black hover:bg-red-500"
        >
